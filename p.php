...
<box>
    <img id="php" src="php_logo.jpeg" width="100%"height="65%"> </box>
    <ul class="nav justify-content-left">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="http://csmath.uprm.edu/~eloitz/"style="color: black;font-family:fantasy;">GO BACK</a>
        </li>
        <br>
        <br>
        <br>
...
<body>
<div align="center"> <img id="std" src="std.jpg" width="80%" height="80%"> </div>
    <?php
    ...
    <div align="center"> <img id="calendar" src="calendar.jpeg" width="75%" height="110%"> </div>
     <br>
     <br>
    <div align="center">
...
?>
<div align="center"> <img id="math" src="math.jpg" width="80%" height="80%"> </div>
<br>
<br>
<div align="center">
